 ...
 * @author lmoentje
 */
public class WorkAdjustApprovedSupplier extends javax.swing.JFrame {

    /**
     * Creates new form WorkAdjustApprovedSupplier
     */
    public WorkAdjustApprovedSupplier() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Are changes approved by the supplier?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WorkAdjustApprovedSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WorkAdjustApprovedSupplier().setVisible(true);
            }
        });
    }
